...
# @module B02 Home/consent
# @requirements F01, F02, F10, E08, AI02, AI04, NFR-07
# Requirement links identify design responsibility, not completed acceptance coverage.
# See docs/progress/Requirement_Traceability.csv and the v2.0 LLD for boundaries.
# HomeService creates household state and records consent/mode changes in an in-memory store. A production
# transaction must make household, memberships and audit records consistent. Consent withdrawal must also
# reach devices and retention workers; changing one dictionary is not the full privacy flow.
...
class HomeService:
    ...
    # @requirements F01, F02, F10, E08, AI02, AI04, NFR-07
    # Change server consent/mode; production must propagate collection stop and retention actions to the
    # devices.
