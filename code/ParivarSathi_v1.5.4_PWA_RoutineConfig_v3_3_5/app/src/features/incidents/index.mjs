...
// @module A04 App incidents
// @requirements F07, F12, F13, NFR-10
// Requirement links identify design responsibility, not completed acceptance coverage.
// See docs/progress/Requirement_Traceability.csv and the v2.0 LLD for boundaries.
// Incident UI helpers expose actions consistent with a snapshot and build commands with idempotency keys.
// The server repeats authorisation and lease checks because the view can be stale. A pending click must
// not be shown as completed human acknowledgement before a confirmed result.
...
// @requirements F07, F12, F13, NFR-10
// Build an idempotent caregiver command; server authorisation and lease checks remain mandatory.
...
// @requirements F07, F12, F13, NFR-10
// Explain provider state without equating provider acceptance to a human acknowledgement.
