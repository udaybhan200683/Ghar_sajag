...
# @module B05 Notification routing
# @requirements F07, F08, F09, F12, F13, F14, E05
# Requirement links identify design responsibility, not completed acceptance coverage.
# See docs/progress/Requirement_Traceability.csv and the v2.0 LLD for boundaries.
# NotificationService is a scheduler/state model, not an SMS or push sender. due returns created jobs
# whose deadline arrived. provider_result records acceptance/failure; it does not implement a retry
# worker. Daily summaries need date filtering and consent enforcement before use outside fixtures.
...
class NotificationService:
    ...
    # @requirements F07, F08, F09, F12, F13, F14, E05
    # Create idempotent primary and backup jobs; actual provider I/O is a separate worker responsibility.
    ...
    # @requirements F07, F08, F09, F12, F13, F14, E05
    # Return due CREATED jobs and cancel unsent jobs for acknowledged/resolved incidents; FAILED-job retry
    # is not implemented.
    ...
    # @requirements F07, F08, F09, F12, F13, F14, E05
    # Record provider acceptance or failure separately from human acknowledgement; this does not prove
    # phone receipt.
    ...
    # @requirements F07, F08, F09, F12, F13, F14, E05
    # Stop pending escalation and update accepted jobs after an explicit human action.
    ...
    # @requirements F07, F08, F09, F12, F13, F14, E05
    # Build the host summary model; date-window filtering and direct consent enforcement remain G07.
