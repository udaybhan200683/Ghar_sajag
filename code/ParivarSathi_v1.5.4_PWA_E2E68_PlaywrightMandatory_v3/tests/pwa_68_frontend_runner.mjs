...
assert.equal((rendered.match(/data-case-status="PASS"/g)||[]).length,68);
console.log('PASS frontend JS E2E: 68/68 canonical scenarios evaluated and rendered as PASS');
